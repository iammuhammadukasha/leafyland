...
export function ServiceCard({ name, price, rating, reviews, image, slug }: ServiceCardProps) {
  const to = slug ? `/services/${slug}/book` : '/services';

  return (
    <Link to={to} className="min-w-[160px] md:min-w-[200px] flex-shrink-0 group block">
      <article>
